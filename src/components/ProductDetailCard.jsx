...
export default function ProductCard({
  ...
  return (
    <div className="max-w-6xl mx-auto bg-gray-50 rounded-lg overflow-hidden shadow-2xl md:grid md:grid-cols-2 md:gap-12 p-6">
      {/* Image Gallery */}
      ...
      <div className="flex flex-col justify-between p-6 space-y-6 md:space-y-8">
        ...
        <div className="flex gap-6 mt-4">
          <button className="flex-1 bg-blueText text-white py-2 px-4 rounded-3xl shadow-lg hover:bg-custom-gradient transition-colors">
            Select Options
          </button>
          <div className="flex gap-4">
            <button className="md:p-3 p-1 border-2 border-gray-200 rounded-lg hover:bg-gray-50 transition-all">
              <Heart className="w-6 h-6 text-gray-600 hover:text-red-500" />
            </button>
            <button
              onClick={handleAddToCart}
              className="md:p-3 p-1 border-2 border-gray-200 rounded-lg hover:bg-gray-50 transition-all"
            >
